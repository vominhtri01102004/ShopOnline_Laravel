...
class ProductController extends Controller
{
    ...
    public function all_product(){
        ...
        ->join('brand','brand.brand_id','=','tbl_product.brand_id')->orderby('tbl_product.brand_id','desc')->get();
    ...
    public function unactive_product($product_id){
        ...
        Session::put('message','Không kích sản phẩm thành công');
        return Redirect::to('all-product');
    }
    ...
    public function details_product($product_id){
        ...
        ->join('tbl_category_product','tbl_category_product.category_id','=','tbl_product.category_id')
        ->join('brand','brand.brand_id','=','tbl_product.brand_id')->where('tbl_product.product_id',$product_id)->get();
