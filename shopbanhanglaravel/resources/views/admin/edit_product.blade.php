                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style=" resize:none " rows="5" class="form-control" name="product_desc" id="exampleInputPassword1">{{$pro->product_desc}}
                                </textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="string" class="form-control" id="exampleInputEmail1" name="product_price" value="{{$pro->product_price}}">
                                </div>
